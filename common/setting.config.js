...
class Setting {
	constructor(
		...
		this._appVersion = appVersion; // 应用名称
		this._copyrightInfo = copyrightInfo; // 应用名称
		...
		this._productPosterTitle = productPosterTitle; // 法宝海报推广语
...
export default new Setting(
	$mConstData.appName,
	$mConstData.appVersion,
	$mConstData.copyrightInfo,
	$mConstData.logo,
	'1',
	$mConstData.logo,
	true,
