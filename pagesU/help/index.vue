	...
	<view>
		...
		<view class="all-wrapper" v-if="tabCurrentIndex==1">
			...
			<view class="qa-wrapper">
				<uni-list>
				    <uni-list-item @click="navDetail(item)" v-for="(item,index) in qas" :title="item.title" :show-extra-icon="false" :extra-icon="{color: '#909399',size: '22',type: 'help-filled'}"></uni-list-item>
				</uni-list>
			</view>
		</view>
		<!-- #ifdef MP-WEIXIN -->
