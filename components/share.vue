	...
	export default {
		...
		methods:{
			...
			let userInfo = uni.getStorageSync('userInfo')
				return {
                		    title: "标题",
                		    path: "../../pagesA/product/product?id=" + this.goods.id + "&invitecode" + userInfo.id,  //页面路径及参数
                		    imageUrl:this.goods.pic + "?temp=" + Date.parse(new Date()),  //图片链接，必须是网络连接，后面拼接时间戳防止本地缓存
